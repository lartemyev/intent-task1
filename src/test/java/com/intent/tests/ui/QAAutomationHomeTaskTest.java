...
import com.intent.task.framework.config.ConfigurationBrowser;
import com.intent.task.models.UserModel;
import com.intent.task.objects.api.ShippingInformationRequest;
import com.intent.tests.dataproviders.UsersDP;
...
import static com.intent.task.framework.config.Constants.SAVED_FILES_FOLDER;
import static com.intent.task.framework.config.enums.Browser.*;
import static com.intent.task.framework.tags.TestPriorityTags.HIGH_PRIORITY_TAG;
import static com.intent.task.framework.utils.FilesUtils.saveTextToFile;
...
public class QAAutomationHomeTaskTest extends BaseTestUi {
    ...
    public void createAUtilityMethodThatInitializesFirefoxDriverUsingSeleniumTest() {
        /* ************************ [STEP 1] ****************************
         * Create a Firfox driver instance with rejected third-party
